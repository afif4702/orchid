    ...
    <form method="post" action="" data-aos="fade-up" data-aos-delay="100">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="jenis" id="email" placeholder="Your Email" data-rule="email"  value="<?=@$jenis?>" data-msg="Please enter a valid email" required>
                  <div class="validate"></div>
                </div>
                <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
                  <input type="text" class="form-control" name="harga" id="phone" placeholder="Your Phone" data-rule="minlen:4" value="<?=@$harga?>" data-msg="Please enter at least 4 chars" required>
                  <div class="validate"></div>
                </div>
                <div class="col-lg-4 col-md-6 form-group mt-3">
                  <input type="text" name="deskripsi" class="form-control" id="date" placeholder="Number of People" data-rule="minlen:4" value="<?=@$deskripsi?>" data-msg="Please enter at least 4 chars" required>
                  <div class="validate"></div>
                </div>
                <div class="col-lg-4 col-md-6 form-group mt-3">
                  <input type="file" class="form-control" name="gambar" id="time" placeholder="Date" data-rule="minlen:4" value="<?=@$gambar?>" data-msg="Please enter at least 4 chars" required>
                  <div class="validate"></div>
                </div>
                </div>
                <br>
